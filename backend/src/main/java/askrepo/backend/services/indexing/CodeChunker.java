...
public class CodeChunker {
    ...
    private Map<String,Object> baseMetadata(String repoId,String filePath,String language){
    ...
    private Document withChunkIndex(Document document,String repoId,String filePath,String language,int chunkIndex){
